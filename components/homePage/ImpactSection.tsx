...
export default function ImpactSection() {
  ...
  return (
    <section
      className="container bg-cyan-200 rounded-b-lg mx-auto px-4 py-16 min-h-[75dvh]"
      id="impact"
    >
      ...
      <div className="w-11/12 mx-auto  flex flex-col items-center   gap-8 mt-16">
        {impactStats.map((impact) => (
          <Card
            key={impact.id}
            className={clsx({
              "w-11/12 lg:w-6/12 -ml-20 lg:-ml-96": impact.id === 1,
              "w-11/12 lg:w-7/12 -ml-10 lg:-ml-40": impact.id === 2,
              "w-11/12 lg:w-8/12 -ml-4 lg:-mr-60": impact.id === 3,
            })}
          >
            <CardHeader>
              <CardTitle></CardTitle>
